## hummel-preludes Makefile
##
## Programmer:    Craig Stuart Sapp <craig@ccrma.stanford.edu>
## Creation Date: Tue Jun  3 18:16:18 PDT 2014
## Last Modified: Tue Jun  3 18:16:21 PDT 2014
## Filename:      Makefile
## Syntax:        GNU/BSD makefile
##
## Description:   Makefile for basic processing Humdrum data files 
##                for the preludes of J.N. Hummel.
##
...
#           git clone https://github.com/craigsapp/hummel-preludes
#
...
kernscores: humdrum-extras-check
	mkdir -p kernscores; (cd kernscores && humsplit h://hummel/preludes)
	@echo "[0;32m"
...
ifeq ($(shell which curl),)
	...
	for file in kern/*.krn; do \
	   ...
	   curl \
	      "http://kern.humdrum.org/data?l=hummel/preludes&file=$$TBASE.krn&format=pdf" \
...
ifeq ($(wildcard .git),)
	...
	@echo "***    [0;32mgit clone https://github.com/craigsapp/hummel-preludes[0;31m"
	@echo "[0m"
	exit 1
endif
